...
- SGLang is measured on only one A10G with a 0.6B model; scale, tensor
  parallelism, and multi-tenant pressure need a GPU fleet (a live-server test
  exists but is unrun here).
